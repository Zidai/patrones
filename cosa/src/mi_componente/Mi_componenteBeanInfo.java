...
public class Mi_componenteBeanInfo extends SimpleBeanInfo {
    ...
    private static final int PROPERTY_dato = 1;
    private static final int PROPERTY_decimal = 2;
    private static final int PROPERTY_enabled = 3;
    private static final int PROPERTY_etiqueta = 4;
    private static final int PROPERTY_letras = 5;
    private static final int PROPERTY_maximo = 6;
    private static final int PROPERTY_maximodec = 7;
    private static final int PROPERTY_minimo = 8;
    private static final int PROPERTY_minimodec = 9;
    private static final int PROPERTY_NDecimal = 10;
    private static final int PROPERTY_numeros = 11;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            ...
            properties[PROPERTY_dato] = new PropertyDescriptor ( "dato", mi_componente.Mi_componente.class, "getDato", "setDato" ); // NOI18N
            properties[PROPERTY_decimal] = new PropertyDescriptor ( "decimal", mi_componente.Mi_componente.class, "getDecimal", "setDecimal" ); // NOI18N
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", mi_componente.Mi_componente.class, "isEnabled", "setEnabled" ); // NOI18N
            ...
            properties[PROPERTY_letras] = new PropertyDescriptor ( "letras", mi_componente.Mi_componente.class, "getletras", "setletras" ); // NOI18N
            properties[PROPERTY_maximo] = new PropertyDescriptor ( "maximo", mi_componente.Mi_componente.class, "getMaximo", "setMaximo" ); // NOI18N
            properties[PROPERTY_maximodec] = new PropertyDescriptor ( "maximodec", mi_componente.Mi_componente.class, "getMaximodec", "setMaximodec" ); // NOI18N
            properties[PROPERTY_minimo] = new PropertyDescriptor ( "minimo", mi_componente.Mi_componente.class, "getMinimo", "setMinimo" ); // NOI18N
            properties[PROPERTY_minimodec] = new PropertyDescriptor ( "minimodec", mi_componente.Mi_componente.class, "getMinimodec", "setMinimodec" ); // NOI18N
            properties[PROPERTY_NDecimal] = new PropertyDescriptor ( "NDecimal", mi_componente.Mi_componente.class, "getNDecimal", "setNDecimal" ); // NOI18N
