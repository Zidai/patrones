...
public class DatoBeanInfo extends SimpleBeanInfo {
    ...
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( Dato.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor
    ...
    private static final int PROPERTY_decimal = 1;
    private static final int PROPERTY_etiqueta = 2;
    private static final int PROPERTY_letras = 3;
    private static final int PROPERTY_maximo = 4;
    private static final int PROPERTY_maximoDec = 5;
    private static final int PROPERTY_minimo = 6;
    private static final int PROPERTY_minimoDec = 7;
    private static final int PROPERTY_ndecimales = 8;
    private static final int PROPERTY_numeros = 9;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_caracteres] = new PropertyDescriptor ( "caracteres", Dato.class, "getCaracteres", "setCaracteres" ); // NOI18N
            properties[PROPERTY_decimal] = new PropertyDescriptor ( "decimal", Dato.class, "getDecimal", "setDecimal" ); // NOI18N
            properties[PROPERTY_etiqueta] = new PropertyDescriptor ( "etiqueta", Dato.class, "getEtiqueta", "setEtiqueta" ); // NOI18N
            properties[PROPERTY_letras] = new PropertyDescriptor ( "letras", Dato.class, "getLetras", "setLetras" ); // NOI18N
            properties[PROPERTY_maximo] = new PropertyDescriptor ( "maximo", Dato.class, "getMaximo", "setMaximo" ); // NOI18N
            properties[PROPERTY_maximoDec] = new PropertyDescriptor ( "maximoDec", Dato.class, "getMaximoDec", "setMaximoDec" ); // NOI18N
            properties[PROPERTY_minimo] = new PropertyDescriptor ( "minimo", Dato.class, "getMinimo", "setMinimo" ); // NOI18N
            properties[PROPERTY_minimoDec] = new PropertyDescriptor ( "minimoDec", Dato.class, "getMinimoDec", "setMinimoDec" ); // NOI18N
            properties[PROPERTY_ndecimales] = new PropertyDescriptor ( "ndecimales", Dato.class, "getNdecimales", "setNdecimales" ); // NOI18N
            properties[PROPERTY_numeros] = new PropertyDescriptor ( "numeros", Dato.class, "getNumeros", "setNumeros" ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( Dato.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( Dato.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( Dato.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( Dato.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( Dato.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( Dato.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( Dato.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( Dato.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( Dato.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( Dato.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( Dato.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( Dato.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( Dato.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_keyPressed73] = new MethodDescriptor(Dato.class.getMethod("keyPressed", new Class[] {java.awt.event.KeyEvent.class})); // NOI18N
            methods[METHOD_keyPressed73].setDisplayName ( "" );
            methods[METHOD_keyReleased74] = new MethodDescriptor(Dato.class.getMethod("keyReleased", new Class[] {java.awt.event.KeyEvent.class})); // NOI18N
            methods[METHOD_keyReleased74].setDisplayName ( "" );
            methods[METHOD_keyTyped75] = new MethodDescriptor(Dato.class.getMethod("keyTyped", new Class[] {java.awt.event.KeyEvent.class})); // NOI18N
